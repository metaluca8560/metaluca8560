// 루트 summer-vacation.html을 미니앱용 index.html로 변환하는 스크립트.
...
const src = readFileSync(join(here, '..', 'summer-vacation.html'), 'utf8');
...
console.log('miniapp-summer/index.html generated from ../summer-vacation.html');
