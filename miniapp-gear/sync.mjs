// 루트 workout-gear.html을 미니앱용 index.html로 변환하는 스크립트.
...
const src = readFileSync(join(here, '..', 'workout-gear.html'), 'utf8');
...
console.log('miniapp-gear/index.html generated from ../workout-gear.html');
