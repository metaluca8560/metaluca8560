// 루트 my-age.html을 미니앱용 index.html로 변환하는 스크립트.
...
const src = readFileSync(join(here, '..', 'my-age.html'), 'utf8');
...
console.log('miniapp-age/index.html generated from ../my-age.html');
