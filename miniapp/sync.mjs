// 루트 salary-analyzer.html을 미니앱용 index.html로 변환하는 스크립트.
...
const src = readFileSync(join(here, '..', 'salary-analyzer.html'), 'utf8');
...
console.log('miniapp/index.html generated from ../salary-analyzer.html');
