// 루트 severance-calc.html을 미니앱용 index.html로 변환하는 스크립트.
...
const src = readFileSync(join(here, '..', 'severance-calc.html'), 'utf8');
...
console.log('miniapp-gear/index.html generated from ../severance-calc.html');
