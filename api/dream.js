...
function resolveOrigin(req) {
  ...
  // 앱인토스 미니앱 도메인 — 전부 허용
  // SDK 2.x: <appName>.(private-)apps.tossmini.com / SDK 3.x: <appName>.(private-)web.tossmini.com
  if (/^https:\/\/[a-z0-9-]+\.(private-)?(apps|web)\.tossmini\.com$/.test(origin)) return origin
