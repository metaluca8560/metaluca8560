...
const FIRST_AID = [
  ...
  {
    ico: "☀️", title: "더위 먹었을 때 (열사병·온열질환)", keys: "열사병 더위 일사병 온열질환 탈진",
    steps: [
      "즉시 시원하고 그늘진 곳으로 옮기세요.",
      "옷을 느슨하게 하고 물·부채·찬 물수건으로 목·겨드랑이·사타구니를 식히세요.",
      "의식이 또렷하면 물이나 이온음료를 천천히 마시게 하세요.",
    ],
    dont: ["의식이 없을 때 억지로 물을 먹이지 마세요(기도로 넘어갈 수 있어요)."],
    call119: "의식이 흐리거나, 몸이 펄펄 끓는데 땀이 안 나고 헛소리를 하면(열사병) 즉시 119 — 생명이 위험할 수 있어요.",
  },
  {
    ico: "🥶", title: "추위에 오래 떨었을 때 (저체온증)", keys: "저체온증 추위 동상 한랭",
    steps: [
      "따뜻하고 바람 없는 곳으로 옮기세요.",
      "젖은 옷은 벗기고 마른 담요·옷으로 머리·목·몸통 위주로 감싸세요.",
      "의식이 또렷하면 따뜻한(뜨겁지 않은) 단 음료를 주세요.",
    ],
    dont: ["술·뜨거운 물·심한 마사지, 팔다리만 급히 데우기는 피하세요(심장에 무리)."],
    call119: "의식이 처지거나 떨림이 멈추고 몸이 뻣뻣해지면 즉시 119. 숨·맥박이 없으면 가슴 압박(CPR).",
  },
  {
    ico: "🐶", title: "동물·사람에게 물렸을 때", keys: "동물 개 고양이 물림 교상 광견병 파상풍",
    steps: [
      "흐르는 물과 비누로 상처를 5분 이상 충분히 씻으세요.",
      "출혈이 있으면 깨끗한 천으로 직접 눌러 지혈하세요.",
      "소독한 뒤 깨끗한 거즈로 덮으세요.",
    ],
    call119: "깊거나 넓은 상처, 얼굴·손, 멈추지 않는 출혈, 들개·야생동물·박쥐에 물렸으면 즉시 병원(광견병·파상풍 예방). 붓고 열나고 진물 나면 감염, 진료.",
  },
  {
    ico: "🤢", title: "식중독·심한 설사·구토", keys: "식중독 설사 구토 배탈 탈수",
    steps: [
      "수분을 조금씩 자주 보충하세요(이온음료·보리차). 탈수가 가장 위험해요.",
      "기름지고 자극적인 음식은 피하고, 속이 가라앉으면 미음·죽부터 드세요.",
      "충분히 쉬세요.",
    ],
    dont: ["함부로 지사제(설사 멈추는 약)를 먹지 마세요 — 독소 배출을 막을 수 있어요(특히 발열·혈변 동반 시)."],
    call119: "혈변·검은 변, 고열, 심한 복통, 소변이 거의 없고 축 처지면(탈수) 빨리 병원. 아이·어르신은 더 빨리.",
  },
  {
    ico: "☠️", title: "약·세제 등을 삼켰을 때 (중독)", keys: "중독 약 세제 표백제 농약 삼킴 음독",
    steps: [
      "무엇을·얼마나·언제 삼켰는지 용기와 포장을 챙기세요.",
      "입안에 남은 것은 뱉어내고 입을 헹구세요.",
      "즉시 119에 전화해 무엇을 삼켰는지 알리고 지시를 따르세요.",
    ],
    dont: ["함부로 토하게 하지 마세요 — 표백제·세제·산/알칼리·석유류는 토하면 더 위험합니다.", "지시 없이 우유·물을 억지로 먹이지 마세요."],
    call119: "의식 저하·호흡곤란·경련이 있으면 즉시 119.",
  },
  {
    ico: "⚡", title: "감전됐을 때", keys: "감전 전기 누전 전선",
    steps: [
      "먼저 전원을 차단하세요(두꺼비집·플러그). 차단 전엔 절대 맨손으로 만지지 마세요.",
      "전원을 못 끄면 고무·마른 나무 등 전기가 안 통하는 물건으로 전선을 떼어내세요.",
      "안전해지면 의식·호흡을 확인하고, 없으면 119 + 가슴 압박(CPR). 화상 부위는 흐르는 물로 식히세요.",
    ],
    dont: ["감전 중인 사람을 맨손으로 만지지 마세요(같이 감전됩니다)."],
    call119: "의식 없음·호흡곤란·화상이 있으면 즉시 119. 고압 감전은 겉이 멀쩡해도 속이 다칠 수 있어 반드시 진료.",
  },
  {
    ico: "🦷", title: "치아가 빠졌을 때", keys: "치아 이 빠짐 탈구 치과",
    steps: [
      "빠진 치아는 뿌리를 만지지 말고 머리(씹는 면)만 잡으세요.",
      "더러우면 우유나 식염수로 살짝 헹구세요(문지르지 않기).",
      "가능하면 원래 자리에 살짝 끼우거나, 차가운 우유(또는 식염수)에 담가 30분~1시간 안에 치과로 가세요.",
    ],
    dont: ["마른 채로 휴지·주머니에 보관하거나 문질러 닦지 마세요."],
    seeDoctor: "빠를수록 치아를 살릴 확률이 높아요. 곧장 치과(또는 응급실 구강악안면)로.",
  },
];
